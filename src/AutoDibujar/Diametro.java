...
public class Diametro extends javax.swing.JDialog {
 ...
 private int [][]Doble=new int[10][10];
    ...
    public Diametro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Visualizador del Diametro del Grafo (Camino Maximo)");
        setResizable(false);
   ...
   AreaDibujo.aristas[j].puntoA.posicion.y==AreaDibujo.puntos[Elegido.Recorrido[w+1]].posicion.y))
    ...
    for(int i=0;i<AreaDibujo.indicePuntos+1;i++)
        ...
        for( Next=0;Next<Elegido.Cant-1;Next++){
            contar=contar + AreaDibujo.aristas[Next].peso;
   ...
   AreaDibujo.aristas[j].puntoA.posicion.y==AreaDibujo.puntos[Lista[i].Recorrido[w+1]].posicion.y))
   {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Diametro dialog = new Diametro(new javax.swing.JFrame(), true);
